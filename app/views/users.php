<?php $this->layout('layoutUsers', ['title' => 'Главная', 'footer' => true]) ?>
...
<main id="js-page-content" role="main" class="page-content mt-3">
    ...
    <div class="row" id="js-contacts">
        ...
        <!--Циклом вывожу всех пользователей и подставляю данные с БД-->
                    ...
                    <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                        <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                     <a href="/profile/<?=$user['id']; ?>"><span class="rounded-circle profile-image d-block " style="background-image:url('images/avatars/<?=$user['image'];?>'); background-size: cover;"></span></a>
                                </span>
                            <div class="info-card-text flex-1">
                                ...
                                <?php  if ($currentUser == $user['email'] || $admin):  ?>
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="/deleteUser/<?=$user['id']; ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                    ...
                    <div class="card-body p-0 collapse show">
                        <div class="p-3">
                            ...
                            <div class="d-flex flex-row">
                                <a href="<?= $user['vkontakte'] ?>" class="mr-2 fs-xxl" style="color:#4680C2">
                                    <i class="fab fa-vk"></i>
                                </a>
